...
- (void)testListPrefix
{
	...
	NSAttributedString *prefix = [NSAttributedString prefixForListItemWithCounter:3 listStyle:listStyle listIndent:30 attributes:attributes context:nil];
	...
	XCTAssertTrue(paragraphStyle.headIndent == (CGFloat)30, @"head ident should be equal to 30");
