...
- (void)testShadowInvalid
{
	...
	XCTAssertNil(shadows, @"Got back an array with %d entries instead of nil", [shadows count]);
}
...
- (void)textBackgroundColor
{
	...
	XCTAssertEqualObjects(@"rgb(255, 0, 0)", color, @"Background color should be \"rgb(255, 88, 44)\"");
}
